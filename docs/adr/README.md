...
| Import/export and Airtable migration | [ADR 0004](./0004-import-export-airtable-migration.md) owns CSV preview/commit/export and Airtable migration staging. [ADR 0006](./0006-migration-grade-import-ux-and-table-state.md) owns migration-grade import modes, route-safe table/view state, imported-grid scrolling, and table rename/delete migration UX. |
| Production readiness | [ADR 0007](./0007-production-readiness-reliability-safety.md) owns the production gate for env validation, route inventory, safe errors, rate limits, durable import jobs, release smoke, observability, load gates, and recovery paths before public/product expansion. |
...
| Views/query | [ADR 0005](./0005-views-query-scale.md) owns server-side view pages, projection, pagination, and indexing choices. |
